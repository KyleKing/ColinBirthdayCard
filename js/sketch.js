// Script from: https://github.com/andrewdcampbell/jsfireworks
...
class Shell {
    constructor(position, speed, type, sparkleTrail) {
        ...
        if (type == undefined) {
            let randIndex = floor(random(0, SHELL_TYPES.length));
            type = SHELL_TYPES[randIndex];
            // type = SHELL_TYPES[7];
        }
